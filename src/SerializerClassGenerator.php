...
EOF;
    ...
    private function isPropertiesGroupExposed(): string
    {
        return <<<EOF
     ...
     * @return bool
     */
    private function isPropertyGroupExposed(string \$property, SerializationContext \$context)
    {
     ...
     * @return bool
     */
    private function isVirtualPropertyGroupExposed(string \$property, SerializationContext \$context)
    {
